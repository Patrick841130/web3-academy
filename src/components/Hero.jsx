        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-brand-dark px-4 py-20">
            ...
            <div className="relative z-10 max-w-5xl mx-auto text-center">
                ...
                >
                    ...
                    {/* --- 일정한 빛이 흐르는 네온 테두리(Border Beam) 주소 박스 시작 --- */}
                    <div className="relative mx-auto max-w-max mb-12 p-[1.5px] overflow-hidden rounded-2xl flex items-center justify-center">
                        
                        {/* 회전하는 단일 빛줄기 (혜성 효과) */}
                        <motion.div
                            animate={{ rotate: 360 }}
                            transition={{ duration: 4, repeat: Infinity, ease: "linear" }}
                            className="absolute w-[150%] h-[150%] opacity-100"
                            style={{
                                background: "conic-gradient(from 0deg, transparent 65%, #a855f7 85%, #22d3ee 100%)",
                            }}
                        />
                        
                        {/* 내부 어두운 박스 (배경을 가려서 테두리만 보이게 함) */}
                        <div className="relative px-8 py-3 bg-[#0D0D12] rounded-[14px] flex items-center justify-center">
                            <p className="text-lg tracking-wide">
                                <strong className="text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]">
                                    서울시 강남구 논현로87길 19, 6층
                                </strong>
                            </p>
                        </div>

                        {/* 박스 외곽에 아주 은은한 유리 질감 테두리 추가 */}
